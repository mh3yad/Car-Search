            ...
            <div class="car-images-and-description">
                ...
                <div class="card car-detailed-description">
                    ...
                    <ul class="car-specifications">
                        @foreach($car->features->getAttributes() as $feature => $value )
                            <li style="display: flex; align-items: center; gap: 6px;">
                                @if($value)
                                    ...
                                    <svg
                                            ...
                                            viewBox="0 0 24 24"
                                            fill="currentColor"
                                            style="color: rgb(0, 192, 102); width: 20px; height: 20px;"
                                    >
                                        <path
                                                fill-rule="evenodd"
                                ...
                                @else
                                    ...
                                    <svg
                                            ...
                                            viewBox="0 0 24 24"
                                            fill="currentColor"
                                            style="color: rgb(248, 0, 0); width: 20px; height: 20px;"
                                    >
                                        <path
                                                fill-rule="evenodd"
                                                d="M12 2.25c-5.385 0-9.75 4.365-9.75 9.75s4.365 9.75 9.75 9.75 9.75-4.365 9.75-9.75S17.385 2.25 12 2.25Zm3.53 6.72a.75.75 0 0 0-1.06-1.06L12 10.94 9.53 7.91a.75.75 0 1 0-1.06 1.06L10.94 12l-2.47 2.03a.75.75 0 1 0 1.06 1.06L12 13.06l2.47 2.03a.75.75 0 0 0 1.06-1.06L13.06 12l2.47-2.03Z"
                                                clip-rule="evenodd"
                                        />
                                    </svg>
                                @endif
